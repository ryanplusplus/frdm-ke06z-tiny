...
void I2C1_EV_IRQHandler(void) {
  ...
  flags = I2C_ReadRegister(I2C1, I2C_Register_ISR);

  // TX data register empty or TX interrupt status (whatever that means)
  if(flags & (I2C_ISR_TXE | I2C_ISR_TXIS)) {
...
static void write(
  ...
  I2C_TransferHandling(
    ...
    address << 1,
    buffer_size,
    prepare_for_restart ? I2C_SoftEnd_Mode : I2C_AutoEnd_Mode,
...
static void configure_i2c1(void) {
  ...
  i2c.I2C_Timing = 0x10808DD3; // Magic, pulled from STM32Cube
  I2C_Init(I2C1, &i2c);
